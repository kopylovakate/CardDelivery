...
public class CardDeliveryTest {
    ...
    @Test
    void validTest() {
        applicationPage.fillForm("Москва", 3, "Мария Попова", "+79281234567");
    ...
    void incorrectDateTest() {
        applicationPage.fillForm("Москва", 3, "Мария Попова", "+7281234567");
    ...
    void emptyCityLineTest() {
        applicationPage.fillForm("", 3, "Мария Попова", "+7281234567");
        $x("//*[@data-test-id='agreement']").click();
        $x("//button[descendant::*[*[contains(text(),'Забронировать')]]]").click();
    ...
    void emptyPhoneLineTest() {
        applicationPage.fillForm("Москва", 3, "Мария Попова", "");
        $x("//*[@data-test-id='agreement']").click();
        $x("//button[descendant::*[*[contains(text(),'Забронировать')]]]").click();
    ...
    void emptyNameLineTest() {
        applicationPage.fillForm("Москва", 3, "", "+79281234567");
        $x("//*[@data-test-id='agreement']").click();
        $x("//button[descendant::*[*[contains(text(),'Забронировать')]]]").click();
    ...
    void lineCityInvalidInputTest() {
        applicationPage.fillForm("Москва1", 3, "Мария Попова", "+79281234567");
        $x("//*[@data-test-id='agreement']").click();
        $x("//button[descendant::*[*[contains(text(),'Забронировать')]]]").click();
    ...
    void lineNameInvalidInputTest() {
        applicationPage.fillForm("Москва", 3, "Maria Popova", "+79281234567");
        $x("//*[@data-test-id='agreement']").click();
        $x("//button[descendant::*[*[contains(text(),'Забронировать')]]]").click();
    ...
    void linePhoneInvalidInputTest() {
        applicationPage.fillForm("Москва", 3, "Мария Попова", "19281234567");
        $x("//*[@data-test-id='agreement']").click();
        $x("//button[descendant::*[*[contains(text(),'Забронировать')]]]").click();
